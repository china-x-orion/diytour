...
//	写芯斜邪胁谢械薪邪 褋械褉胁械褉薪邪褟 泻谢邪褋褌械褉懈蟹邪褑懈褟 写谢褟 褋褌邪薪褑懈泄. 袨薪邪 胁泻谢褞褔械薪邪 锌芯 褍屑芯谢褔邪薪懈褞 写谢褟 泻谢邪褋褋邪 
//	OpenLayers.Layer.Vector.OWMStations
//
//	2012.05.20 Version 1.2
//	写芯斜邪胁谢械薪邪 褋械褉胁械褉薪邪褟 泻谢邪褋褌械褉懈蟹邪褑懈褟. 袨薪邪 胁泻谢褞褔械薪邪 锌芯 褍屑芯谢褔邪薪懈褞 写谢褟 泻谢邪褋褋邪 
//	OpenLayers.Layer.Vector.OWMWeather
//	写谢褟 泻谢邪褋褋邪 OpenLayers.Layer.Vector.OWMStations 胁 薪邪褋褌芯褟褖懈泄 屑芯屑械薪褌 褋械褉胁械褉薪邪褟 泻谢邪褋褌械褉懈蟹邪褑懈褟 薪械 褉邪斜芯褌邪械褌
//
//	2012.05.10 Version 1.1
//	写芯斜邪胁谢械薪邪 泻谢懈械薪褌褋泻邪褟 泻谢邪褋褌械褉懈蟹邪褑懈褟
...
//				type: 'city',
				...
				cnt: 200,
				format: 'json',
				layer: this		// 懈写懈芯褌褋泻芯械 褉械褕械薪懈械, 薪芯 褟 薪械 锌芯薪褟谢 泻邪泻 懈薪邪褔械 写芯褋褌邪褌褜 OpenLayers.Layer.Vector
                        },
                        filterToParams: function(filter, params) {
				if (filter.type === OpenLayers.Filter.Spatial.BBOX) {
					params.bbox = filter.value.toArray();
					params.bbox.push(params.layer.map.getZoom());	//屑邪谐懈褟 - 写芯斜邪胁谢褟褞 zoom 胁 锌邪褉邪屑械褌褉褘
...
days: ["胁芯褋泻褉械褋械薪褜械", "锌芯薪械写械谢褜薪懈泻", "胁褌芯褉薪懈泻", "褋褉械写邪", "褔械褌胁械褉谐", "锌褟褌薪懈褑邪", "褋褍斜斜芯褌邪"],
//days_small: ["胁褋", "锌薪", "胁褌", "褋褉", "褔褌", "锌褌", "褋斜"]
...
function GetWeatherText2(st)
{
	...
	if( st.snow && st.snow['3h'] )
		txt = 'Snow ' + '( ' + st.snow['3h'] +'屑屑 )'; 

	if( st.rain && st.rain['3h'] )
		txt = 'Rain:' + '(' + st.rain['3h'] +'屑屑)'; 
	return txt;
}
...
<div class="weather_block">\
 <div class="cur_weather_block" title="'+wtext+'">\
  ...
  <div class="temp_block" >\
   <div class="big_temp" title="Current Temperature '+dt+'">'+temp+'掳</div>\
   <div class="small_temp_block" >\
    <div class="small_temp">'+wtext+'</div>\
   </div>\
  </div>\
 </div>\
 <div class="small_val_grey" title="Min and max temperature">Min t: '+temp_min+' / Max t: '+temp_max+' 掳C</div>\
...
'<div style="font-size: small; float: left; text-align: center;" >\
 ...
 <div class="small_val" title="Temperature">'+temp+'掳C</div>\
 <div class="small_val" title="袙械褌械褉">'+forecast[i].wind.speed+' m/s</div>\
 <div class="small_val_grey" title="袛邪胁谢械薪懈械">'+forecast[i].main.pressure+'</div>\
</div>'
//<div style="font-size: small; padding: 0pt 3pt;" title="High Temperature">'+temp_max+'掳C</div>\
//<div style="color: gray; font-size: small; padding: 0pt 3pt;" title="Low Temperature">'+temp_min+'掳C</div>\
...
<div class="weather_block">\
 <div class="cur_weather_block" title="'+wdescription+'">\
  ...
  <div class="temp_block" >\
   <div class="big_temp" title="Current Temperature">'+temp+'掳</div>\
   <div class="small_temp_block" >\
    <div class="small_temp">'+wtext+'</div>\
   </div>\
  </div>\
